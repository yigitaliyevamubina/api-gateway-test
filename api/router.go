...
func New(option Option) *gin.Engine {
	...
	corsConfig.AllowCredentials = true          // Allow credentials (e.g., cookies, authorization headers)
	corsConfig.AddAllowHeaders("Authorization") // Allow the Authorization header
